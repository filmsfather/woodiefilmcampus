...
export default async function StudentProgramDetailPage({ params }: ProgramDetailPageProps) {
  ...
  return (
    <section className="space-y-6">
      <DashboardBackLink
        fallbackHref={`/dashboard/student/admission-materials/universities/${universityId}`}
