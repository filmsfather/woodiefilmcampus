...
export default async function WorkbookListPage(props: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <section className="space-y-6">
      ...
      <WorkbookFilters subjects={WORKBOOK_SUBJECTS} activeSubjects={subjectFilter} authors={authors} activeAuthors={authorFilter} types={WORKBOOK_TYPES} typeLabels={WORKBOOK_TITLES} activeTypes={typeFilter} searchQuery={query} />
