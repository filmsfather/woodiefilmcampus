...
export default async function AdmissionReviewsListPage({
  searchParams,
}: {
  ...
  if (error) {
    console.error('[admission-reviews] list query failed', error)
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-600">
            카페에서 옮겨온 합격생 복기 {totalCount}건을 대학·학년도·학생 이름으로 분류해 모았습니다.
          </p>
        </div>
      </div>
