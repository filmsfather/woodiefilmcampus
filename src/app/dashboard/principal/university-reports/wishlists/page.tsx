    ...
    <section className="space-y-6">
      ...
      <header className="space-y-2">
        ...
        <p className="text-sm text-slate-600">
          승인된 전체 학생을 대상으로, 지원 대학이 비슷하고 같은 요일에 수강 가능한 학생끼리 묶어
          반을 편성합니다. <code className="rounded bg-slate-100 px-1">/confirm</code> 폼을 아직
          제출하지 않은 학생은 <span className="font-medium text-rose-600">미확정</span> 배지로
          표시됩니다. 확정하면 실제 반으로 반영됩니다.
        </p>
      </header>
