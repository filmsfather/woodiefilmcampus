...
const QUICK_LINK_SECTIONS: ManagerQuickLinkSection[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { label: '지출증빙 관리', href: '/dashboard/manager/receipts', variant: 'outline' },
  ...
  {
    title: '교육 활동',
    description: '아틀리에·에세이·워크시트 제출물과 시네필 챌린지를 확인하세요.',
    actions: [
      { label: '선생님 아틀리에', href: '/dashboard/teacher/atelier' },
      { label: '선생님 에세이 보드', href: '/dashboard/teacher/essay', variant: 'outline' },
      { label: '선생님 워크시트 보드', href: '/dashboard/teacher/worksheet', variant: 'outline' },
