...
import type { EssayExcellentMonthGroup } from '@/lib/essay-excellent'
import { getEssayAttachmentDownload } from '@/app/dashboard/essay/actions'
import { Button } from '@/components/ui/button'
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@/components/ui/sheet'

interface EssayExcellentShowcaseProps {
  groups: EssayExcellentMonthGroup[]
  viewerId: string
}
...
export function EssayExcellentShowcase({ groups }: EssayExcellentShowcaseProps) {
